...
export type StartRuleNames = "vmLine" | "VmParsedStack";
export interface ParseOptions<T extends StartRuleNames = "vmLine"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"vmLine">>(
  input: string,
  options?: Options,
): any;

declare function ParseFunction<Options extends ParseOptions<"VmParsedStack">>(
  input: string,
  options?: Options,
): any;
